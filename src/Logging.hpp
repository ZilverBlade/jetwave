...
//    if (g_log_output) {
//        g_log_output->Log(devs_out_of_bounds::LogLevel::Debug,
...
//    if (g_log_output) {
//        g_log_output->Log(devs_out_of_bounds::LogLevel::Info,
//            fmt::format(fmt, std::forward<Args>(args)...).c_str());
//    }
//}
//
...
//    if (g_log_output) {
//        g_log_output->Log(devs_out_of_bounds::LogLevel::Warning,
//            fmt::format(fmt, std::forward<Args>(args)...).c_str());
//    }
//}
//
...
//    if (g_log_output) {
//        g_log_output->Log(devs_out_of_bounds::LogLevel::Error,
//            fmt::format(fmt, std::forward<Args>(args)...).c_str());
//    }
//}
//
...
//    if (g_log_output) {
//        g_log_output->Log(devs_out_of_bounds::LogLevel::Fatal,
//            fmt::format(fmt, std::forward<Args>(args)...).c_str());
//    }
//}
